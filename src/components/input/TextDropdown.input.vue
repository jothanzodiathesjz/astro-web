<template>
    ...
    >
        ...
        <ul
            v-if="showDropdown"
            class="absolute w-full z-10 bg-white dark:bg-gray-800 border border-gray-300 dark:border-blue-600 rounded-md overflow-hidden"
            :class="
        ...
        >
            ...
            >
                <div
                    class="hover:bg-gray-100 dark:hover:bg-gray-700 text-sm dark:text-gray-200 rounded-lg mb-1 p-2 w-full"
                    :class="
